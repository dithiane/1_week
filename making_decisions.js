...
if (amysBirthYear === brittanisAge) console.log('Amy & Brittani were born in the same year')
...
if (rain) {
  if (temperature >= 80) console.log ("a t-shirt and take an umbrella")
  else if (temperature > 60 && temperature <80) console.log('a rain-jacket')
  else if (temperature <= 60) console.log("a jacket and carry an umbrella")
} else {
