...
for(let i = letters.length; i >= 0; i--) console.log(letters[i])
...
for (let j = 1; j <= 100; j++) {
    if ((j%3==0) && (j%5==0)) console.log("Devmountain")
    else if (j%3==0) console.log("Dev")
    else if (j%5==0) console.log("mountain")
    else console.log(j)
}